...
import BountyCard from '@/components/blocks/button/bounty-card';
import { CategoryFilter } from '@/components/blocks/filter/category-filter';
import { ChainFilter } from '@/components/blocks/filter/chain-filter';
