...
import { DatePicker } from '@workspace/ui/components/blocks/popover/date-picker';
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Provide a detailed description of what youre looking for
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Specify the skills, experience, or qualifications needed
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <CardContent className='space-y-4'>
                <div className='rounded-lg border p-4'>
                  ...
                  <div className='flex items-center justify-between text-sm'>
                    ...
                    <div>
                      {form.watch('deadline')
                        ? `Due ${form.watch('deadline').toLocaleDateString()}`
                        : 'Deadline'}
                    </div>
                  </div>
                </div>
